...
const creative = [
  { src: Rick, 
    ...
    description: [`In 2017 I bought a 1997 Ford Ranger that had 130,000 miles, with the plan to build a tiny house \
  ...
  { src: YalePress, 
    ...
    description: [`1) This design takes the most liberties with the interpretation of the text. The centered shapes\
  ...
  { src: Posters, 
    ...
    description: [`For the Mass Incarceration poster I researched Mass Incarceration in the US and wrote the poster text, \
  ...
  { src: Sculpture, 
    id: 'Sculpture', 
    title: "Sculpture", 
    description: [`A variety of the sculpture work I did at Yale.
