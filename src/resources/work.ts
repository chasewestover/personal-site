...
import SocialGrove from "../vids/SocialGrove.mp4";
...
const work = [
    {
        ...
        description: [
            `Jobly is a full-stack job board application. Jobly was built using a Node/ Express\
   back-end and a React front-end. Logged in users can browse companies by name and size. They can browse jobs by
    ...
    },
    {
        ...
        description: [
            `Warbler is a Twitter clone that uses Flask, PostgreSQL, and SQLAlchemy on the back-end and Jinja,\
   jQuery, and Axios on the front-end. I built this application off of a semi-functioning clone.`,
    ...
    programming and design and improved my backend testing abilities.`,
        ...
        links: [["Demo", "https://warbler-warbler-warbler.herokuapp.com/"], [""], ["Github", "https://github.com/chasewestover/Flask-Warbler"]],
    },
    {
        src: SocialGrove,
        id: "social-grove",
        ...
        description: [
            `Social Grove is a social dining experience that lets users suggest dishes to be served to
    determine the menu. It uses React on the frontend and a simple json server on the backend to manage the data`,
        ...
        links: [["Demo", "https://social-grove.surge.sh/"], [""], ["Github", "https://github.com/chasewestover/SocialGrove"]],
    },
];
